...
class TestFluxoPagamento(TestCase):
    ...
    def test_nao_deve_processar_pagamento_com_saldo_insuficiente(self):
        ...
        self.assertRaises(ValueError, pagamento.validar_pagamento, 200, saldo_insuficiente, "pix")
    ...
    def test_deve_processar_pagamento_com_saldo_suficiente(self):
        ...
        resultado = pagamento.validar_pagamento(100, saldo_suficiente, "pix")
    ...
    def test_nao_deve_processar_pagamento_com_tipo_invalido(self):
        ...
        self.assertRaises(TypeError, pagamento.validar_pagamento, "cem", 500, "pix")


    def test_nao_deve_processar_pagamento_com_valor_negativo(self):
        pagamento = Pagamento()

        self.assertRaises(ValueError, pagamento.validar_pagamento, -10, 500, 'pix')


    def test_nao_deve_processar_pagamento_com_valor_zero(self):
        pagamento = Pagamento()

        self.assertRaises(ValueError, pagamento.validar_pagamento, 0, 500, "pix")
    ...
    def  test_nao_deve_processar_pagamento_com_saldo_zerado(self):
        ...
        saldo_zerado = 0
        self.assertRaises(ValueError, pagamento.validar_pagamento, 200, saldo_zerado, "pix")

    
    def test_nao_deve_processar_pagamento_com_saldo_informado_de_tipo_invalido(self):
        pagamento = Pagamento()

        self.assertRaises(TypeError, pagamento.validar_pagamento, 100, "quinhentos", "pix")
    ...
    def test_deve_processar_pagamento_quando_metodo_for_pix(self):
        ...
        resultado = pagamento.validar_pagamento(100, 500, "pix")
        self.assertEqual(resultado["valor_a_pagar"], 100)

    def test_nao_deve_processar_pagamento_quando_metodo_for_invalido(self):
        pagamento = Pagamento()

        self.assertRaises(ValueError, pagamento.validar_pagamento, 100, 500, "boleto")

    def test_deve_processar_pagamento_quando_metodo_for_credito(self):
        pagamento = Pagamento()

        resultado = pagamento.validar_pagamento(100, 500, "crédito")
    ...
    def test_deve_processar_pagamento_quando_metodo_for_debito(self):
        ...
        resultado = pagamento.validar_pagamento(100, 500, "débito")
        self.assertEqual(resultado["valor_a_pagar"], 100)
